...
let alltectonicPlates = L.layerGroup();
let majorEQ = L.layerGroup();
...
// Grabbing our boundary GeoJSON data.
d3.json(boundaries).then(function(data) {
    ...
    function styleInfo(feature) {
      return {
        opacity: 1,
        fillOpacity: 1,
        fillColor: getColor(feature.properties.plateA, feature.properties.plateB ),
        color: "#000000",
        radius: getRadius(feature.properties.plateA, feature.properties.plateB),
        stroke: true,
        weight: 0.3
      };
    }
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  }).addTo(allEarthquakes, alltectonicPlates, majorEQ);
